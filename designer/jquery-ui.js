...
$.widget( "ui.droppable", {
	...
	_create: function() {
		...
		this.isover = false;
		this.isout = true;
		this.getUi = typeof getUi === "function" ? getUi : function (d) {
			return this.ui(d);
		};
...
/* 
console.info('draggable.currentItem:', draggable.currentItem);
console.info('this.element:',this.element[0]); */
...
//console.info(draggable.bindings);
...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	_mouseStop: function( event, noPropagation ) {
		...
		if ( this.options.revert ) {
			...
			$( this.helper ).animate(
				animation,
				parseInt( this.options.revert, 10 ) || 100,
				function() {
					that._clear( event );
				}
			);
