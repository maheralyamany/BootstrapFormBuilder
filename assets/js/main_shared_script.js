...
var getStorageValue = function (key, def = null) {
    ...
    changeOptionsThemeClass = function (tag, ref, clas) {
        var val = getStorageValue(tag, '');
        if (val === 'checked')
            $(ref).addClass(clas)
    },
    getNavColorKeyClass = function () {
    ...
    getSidebarColorClass = function () {
        var lightSidebarColor = getStorageValue(lightSidebarKey, 'bg-primary'),
