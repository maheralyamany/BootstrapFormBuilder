...
const SELECTOR_CONTAINER_TOP_RIGHT = '#toastsContainerTopLeft'
const SELECTOR_CONTAINER_TOP_LEFT = '#toastsContainerTopRight'
const SELECTOR_CONTAINER_BOTTOM_RIGHT = '#toastsContainerBottomLeft'
const SELECTOR_CONTAINER_BOTTOM_LEFT = '#toastsContainerBottomRight'

const CLASS_NAME_TOP_RIGHT = 'toasts-top-left'
const CLASS_NAME_TOP_LEFT = 'toasts-top-right'
const CLASS_NAME_BOTTOM_RIGHT = 'toasts-bottom-left'
const CLASS_NAME_BOTTOM_LEFT = 'toasts-bottom-right'

const POSITION_TOP_RIGHT = 'topLeft'
const POSITION_TOP_LEFT = 'topRight'
const POSITION_BOTTOM_RIGHT = 'bottomLeft'
const POSITION_BOTTOM_LEFT = 'bottomRight'
