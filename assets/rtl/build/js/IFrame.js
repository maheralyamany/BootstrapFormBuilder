...
const SELECTOR_DATA_TOGGLE_SCROLL_LEFT = '[data-widget="iframe-scrollright"]'
const SELECTOR_DATA_TOGGLE_SCROLL_RIGHT = '[data-widget="iframe-scrollleft"]'
...
class IFrame {
  ...
  _navScroll(offset) {
    const rightPos = $(SELECTOR_TAB_NAVBAR_NAV).scrollRight()
    $(SELECTOR_TAB_NAVBAR_NAV).animate({ scrollRight: (rightPos + offset) }, 250, 'linear')
  }
